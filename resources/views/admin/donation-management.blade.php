    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="{{ route('admin.donation') }}" class="active"><i
                            class="fas fa-hand-holding-heart"></i>Donations</a></li>
        ...
        <main class="main-content">
            ...
            <div class="table-container">
                ...
                <div class="filter-form">
                    <form action="{{ route('admin.donation') }}" method="GET" class="filter-options">
                        ...
                        <div class="filter-group">
                            ...
                            <select id="donation_type" name="donation_type" class="form-control">
                                ...
                                <option value="one-time"
                                    {{ old('donation_type', $filters['donation_type'] ?? '') == 'one-time' ? 'selected' : '' }}>
                                    One-Time
                                </option>
                                <option value="monthly"
                                    {{ old('donation_type', $filters['donation_type'] ?? '') == 'monthly' ? 'selected' : '' }}>
                                    Monthly
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="filter-group">
                            ...
                            <select id="donation_method" name="donation_method" class="form-control">
                                <option value="">All Methods</option>
                                <option value="card"
                                    {{ old('donation_method', $filters['donation_method'] ?? '') == 'card' ? 'selected' : '' }}>
                                    Card
                                </option>
                                <option value="bank_transfer"
                                    {{ old('donation_method', $filters['donation_method'] ?? '') == 'bank_transfer' ? 'selected' : '' }}>
                                    Bank Transfer
                                </option>
                                <option value="GCash"
                                    {{ old('donation_method', $filters['donation_method'] ?? '') == 'GCash' ? 'selected' : '' }}>
                                    GCash
                                </option>
                            </select>
                        </div>
                    ...
                    <tbody>
                        @foreach ($donations as $donation)
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($donation->created_at)->format('F d, Y') }}</td>
                                <td>
                    ...
                    <div class="pagination-container text-center mt-4">
                        <ul class="pagination justify-content-center">
                            ...
                            @if ($donations->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ $donations->nextPageUrl() }}" aria-label="Next">
                                        &raquo;
                                    </a>
                                </li>
                            @else
