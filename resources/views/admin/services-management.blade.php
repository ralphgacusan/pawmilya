...
<body>
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="{{ route('admin.service') }}" class="active"><i
            ...
            <div class="table-container">
                <div class="table-header">
                    ...
                    <div class="table-actions">
                        <a href="{{ route('admin.add-service-page') }}"><button class="btn btn-primary"
                                id="add-pet-btn">
                ...
                <div class="filter-form">
                    <form action="{{ route('admin.service') }}" method="GET" class="filter-options">
                    ...
                    <tbody>
                        @foreach ($services as $service)
                            <tr>
                                ...
                                <td>
                                    @if ($service->image)
                                        <img src="{{ asset('storage/' . $service->image) ?? 'https://via.placeholder.com/100' }}"
                                ...
                                <td style="white-space: nowrap;">
                                    <a href="{{ route('admin.edit-service', ['id' => $service->service_id]) }}">
                                        <button class="action-btn edit-btn"><i class="fas fa-edit"></i></button>
                                    </a>
                                    <form action="{{ route('admin.delete-service', $service->service_id) }}"
                ...
                @if ($services->hasPages())
                    <div class="pagination-container">
                        <ul class="pagination">
                            ...
                            @else
                                <li><a href="{{ $services->previousPageUrl() }}">&laquo;</a></li>
                            @endif
                            ...
                            @if ($services->hasMorePages())
                                <li><a href="{{ $services->nextPageUrl() }}">&raquo;</a></li>
                            @else
    ...
    <script>
        ...
        // Open the modal when the "Add New Service" button is clicked
