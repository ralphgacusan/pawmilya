    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="{{ route('admin.user') }}" class="active"><i class="fas fa-users"></i>User Management</a>
                </li>
        ...
        <main class="main-content">
            ...
            <div class="table-container">
                ...
                <div class="filter-form">
                    <form action="{{ route('admin.user') }}" method="GET" class="filter-options">
                        <div class="filter-group">
                            <label for="search">Search (Full Name):</label>
                            <div class="search-box">
                                <i class="fas fa-search"></i>
                                <input type="text" id="search" name="search" class="form-control"
                                    placeholder="Enter user's first or last name" value="{{ request('search') }}">
                            </div>
                        </div>

                        <div class="filter-group">
                            <label for="date-filter">Date Joined:</label>
                            <select id="date-filter" name="date" class="form-control">
                                <option value="newest" {{ request('date') == 'newest' ? 'selected' : '' }}>Newest
                                </option>
                                <option value="oldest" {{ request('date') == 'oldest' ? 'selected' : '' }}>Oldest
                                </option>
                            </select>
                        </div>
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('client.delete-user', $user->id) }}" method="POST"
                ...
                {{-- <!-- Pagination links for User Management --> --}}
                @if ($users->hasPages())
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="petType" name="type" class="form-control" required>
                                        ...
                                        <option value="dog" {{ old('type') == 'dog' ? 'selected' : '' }}>Dog
                                        </option>
                                        <option value="cat" {{ old('type') == 'cat' ? 'selected' : '' }}>Cat
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="petBreed" name="breed" class="form-control" required>
                                        ...
                                        <option data-type="cat" value="scottish_fold"
                                            {{ old('breed') == 'scottish_fold' ? 'selected' : '' }}>Scottish Fold
                                        </option>
                                        <option data-type="cat" value="british_shorthair"
                                            {{ old('breed') == 'british_shorthair' ? 'selected' : '' }}>British
                                            Shorthair
                                        </option>
                                        ...
                                        <option data-type="exotic" value="leopard_gecko"
                                            {{ old('breed') == 'leopard_gecko' ? 'selected' : '' }}>Leopard Gecko
                                        </option>
                                        ...
                                        <option data-type="exotic" value="sugar_glider"
                                            {{ old('breed') == 'sugar_glider' ? 'selected' : '' }}>Sugar Glider
                                        </option>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="vaccination_status" name="vaccination_status" class="form-control"
                                        required>
                                        <option value="" disabled
                                            {{ old('vaccination_status') == '' ? 'selected' : '' }}>Select status
                                        </option>
                                        <option value="vaccinated"
                                            {{ old('vaccination_status') == 'vaccinated' ? 'selected' : '' }}>
                                            Vaccinated
                                        </option>
