    ...
    <main>
        ...
        <section class="services-container">
            ...
            <div class="services-grid">
                ...
                <div class="service-card">
                    <div class="service-icon">
                        <img src="checkup.webp" alt="Health Checkup">
                    </div>
                ...
                <div class="service-card">
                    <div class="service-icon">
                        <img src="train.webp" alt="Training">
                    </div>
                ...
                <div class="service-card">
                    <div class="service-icon">
                        <img src="neuter.jpg" alt="Spay/Neuter">
                    </div>
                    <h3>Spay & Neuter</h3>
                    <ul>
                ...
                <div class="service-card">
                    <div class="service-icon">
                        <img src="deworm.webp" alt="Deworming">
                    </div>
                ...
                <div class="service-card">
                    <div class="service-icon">
                        <img src="add.png" alt="Other Services">
                    </div>
            ...
            <div class="service-cta">
                ...
                <div class="cta-buttons">
                    <a href="tel:+1234567890" class="cta-btn phone">Call Now</a>
