<x-customer-layout>
    ...
    @push('styles')
        @vite(['resources/css/adopt.css', 'resources/css/form.css'])
    @endpush
                ...
                <fieldset class="form-section pet-info">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="petType" name="petType" class="form-input" value="Dog"
                                readonly>
                            <span class="input-icon"><i class="icon-pet"></i></span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="petBreed" name="petBreed" class="form-input"
                                placeholder="Labrador Mix" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="petGender" name="petGender" class="form-input" required
                                placeholder="Male/Female" readonly>
